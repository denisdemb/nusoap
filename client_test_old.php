...
<div class="col-md-offset-1 col-md-10 col-md-offset-1">
    ...
    ?>
        <form action="client_test_old.php" method="post" >
    ...
    $client = new nusoap_client('http://172.22.0.141/service.php?wsdl');
      ...
      //echo '</pre>';
          ...
          <div class="table-responsive">
            <table class="table table-hover table-striped table-bordered">
              ...
              <?php
                if(!empty($result[1])){
                  	foreach ($result[1] as $key => $results) {
